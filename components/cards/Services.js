        ...
        <div id='services'>
            ...
            <div className={styles.services}>
                <Card title={"Alisados"} imageSrc={"/images/alisado.svg"} alter={"alisados"} content={alisados} previous={true} before={"/images/alisadobefore.svg"} after={"/images/alisadoafter.svg"}>
                    <li>
                        <Image alt={'reloj'}className={styles.me} src={"/images/reloj.svg"} width={26} height={26}/> De 3 a 5 horas  según el largo y la cantidad de cabello.
                    </li>
                    <li>
                    <Image alt={'carita'}className={styles.me} src={"/images/carita.svg"} width={26} height={30}/> Cualquier tipo de cabello, se recomienda a aquellas personas con el pelo rizado o crespo.
                    </li>
                    <li>
                    <Image alt={'addcircle'}className={styles.me} src={"/images/addcircle.svg"} width={30} height={30}/> No apto para cabellos decolorados
                    </li>
                </Card>
                ...
                <CardReverse title={"Botox Capilar"} imageSrc={"/images/botox.svg"} alter={"botox"} content={botox} previous={true} before={"/images/botoxbefore.svg"} after={"/images/botoxafter.svg"}>
                    <li>
                        <Image alt={'reloj'}className={styles.me} src={"/images/reloj.svg"} width={26} height={26}/> De 3 a 4 horas  según el largo y la cantidad de cabello.
                    </li>
                    <li>
                        <Image alt={'carita'}className={styles.me} src={"/images/carita.svg"} width={26} height={30}/> Apto para todo tipo de cabellos.
                    </li>
                    <br/>
                </CardReverse>
                ...
                <Card title={"Shock de keratina"} imageSrc={"/images/keratina.svg"} alter={"keratina"} content={keratina} previous={true} before={"/images/keratinabefore.svg"} after={"/images/keratinaafter.svg"}>
                    ...
                    <li>
                        <Image alt={'carita'}className={styles.me} src={"/images/carita.svg"} width={26} height={30}/>  Apto para todo tipo de cabellos, especialmente cabellos con alisados.
                    </li>
                    <br/>
                </Card>
